            ...
            <div className="relative min-h-svh bg-white">
              <div className="max-w-[900px] mx-auto relative">
                <div className="px-4 pt-[46px] lg:px-[54px]">
                  ...
                  <h1 className="text-[40px] lg:text-[80px] leading-[.8] font-portlin tracking-[0.4px] mt-[24px]">
                    {project.title}
                  </h1>
                  {project.body && (
                    <PortableText
                      className="mt-[30px] text-sm lg:text-lg leading-normal text-muted-foreground [&_a]:underline [&_a]:text-blue-500"
              ...
              {firstReview && (
                <section className="bg-[#f9f8f3] mt-[80px]">
                  <div className="mx-auto max-w-[900px] px-4 lg:px-[54px] pt-[44px] pb-[57px]">
                    <h2 className="text-center pb-[26px] mb-4 w-max mx-auto text-[30px] lg:text-[60px] font-portlin tracking-[0.4px] -rotate-[4deg] origin-right leading-[.8]">
                      CLIENT EXPERIENCE
                    </h2>
                    <ReviewCard
                      key={firstReview._id}
