  ...
  return (
    <Dialog open={true}>
      ...
      >
        ...
        <div className="hidden xl:block sticky h-0 left-[84%] w-max top-[calc(50%-56px)] z-[10]">
          <div className="flex flex-col gap-[24px]">
            ...
            <div className="flex flex-col items-center">
              <button className="flex bg-primary items-center justify-center size-[70px] border-[1px] rounded-full border-muted">
                <Image
        ...
        <div className="relative min-h-svh bg-white overflow-x-hidden">
          <div className="max-w-[900px] mx-auto relative">
            <div className="px-4 lg:px-[54px]">
              <div className="text-sm px-[12px] py-[10px] rounded-[5px] border border-foreground w-max font-medium leading-[.8] mt-[46px]">
            ...
            <section className="bg-[#f9f8f3] mt-[80px]">
              <div className="mx-auto max-w-[900px] px-4 lg:px-[54px] pt-[44px] pb-[57px]">
                ...
                <p className="text-center text-[15px] text-[#c7c6c4] mt-[23px]">
                  Maintaining a 5/5 Star rating with over 1,600+ reviews from
                  FB, Google and BBB!
                </p>
              </div>
            </section>
