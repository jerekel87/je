      ...
      <div className="z-[1] relative">
        ...
        <div className="container mx-auto lg:max-w-[1920px] h-full relative px-0 lg:px-[2rem]">
          <div className="relative w-max mx-auto">
            <h1 className="text-[78.8px] md:text-[108px] xl:text-[178px] font-portlin leading-[.84] text-center transform -rotate-[5deg] pt-[30px] lg:pt-[74px] w-max">
          ...
          <div className="text-xl lg:text-[41px] text-white font-portlin w-max mx-auto">
